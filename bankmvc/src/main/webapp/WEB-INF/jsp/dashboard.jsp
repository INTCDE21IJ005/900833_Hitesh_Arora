...
<img src="/Realestates/Files/Logo HB.jpg" alt="logo" width="100" height="100">
	...
	<br>
		<h1 align="center"><b>HAKAR BANK EMPLOYEE DASHBOARD</b></h1><br>
		<h6 align="center"> We Value Your Work!</h6>
			...
			<div style="margin: 5em 10em 2em 3em;">
				<div class="card  " style="width: 360px;height:250px; background: rgb(0, 0, 0); /* Fallback color */
					...
					<div class="card-body">
						...
						<br> <a href="/createCustomer" class="btn btn-success">Create Customer</a>
					</div>
					<br><br><br>
				...
				<div class="card" style="width: 360px;height:250px; background: rgb(0, 0, 0); /* Fallback color */
					...
					<div class="card-body">
						...
						<form action="/createAccount" method="post">
							<input type="text" name="customerId" placeholder="Enter Customer ID" autocomplete="off"/>
							<br> <br> <input type="submit" name="View" value="Create Account" class="btn btn-success" />
						</form><br>
				...
				<div class="card" style="width: 360px;height:250px; background: rgb(0, 0, 0); /* Fallback color */
					...
					<div class="card-body">
						...
						<form action="/deleteCustomer" method="post">
							<input type="text" name="customerId" id="customerId" placeholder="Enter Customer ID" autocomplete="off"/>
							<br> <br> <input type="submit" name="Delete" value="Delete Customer" class="btn btn-danger" />
						</form><br>
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 4em 10em 14em 3em;">
				<div class="card" style="width:360px;height:250px; background: rgb(0, 0, 0); /* Fallback color */
  					...
  					color: #f1f1f1;">
					<div class="card-body">
						<h4 class="card-title">View Customer</h4><br>
						<form action="/viewCustomer" method="get">
							<input type="text" name="userId" id="userId" placeholder="Enter Customer ID" autocomplete="off"/>
				...
				<div class="card" style="width:360px;height:250px;background: rgb(0, 0, 0); /* Fallback color */
					...
					<div class="card-body">
						...
						<form action="/deposit" method="post">
							<input type="number"  name="accountId" placeholder="Enter Account ID" autocomplete="off"/><br><br>	
							<input type="number" name="amount" placeholder="Enter Amount in INR" autocomplete="off"/>
							<br> <br>
							<input type="submit" name="View" value="Deposit Amount" class="btn btn-success" />
						</form>
				...
				<div class="card" style="width:360px;height:250px; background: rgb(0, 0, 0); /* Fallback color */
					...
					<div class="card-body">
						...
						<form action="/deductServiceTax" method="post"><br>
                         <input type="submit" name="View" value="Deduct" class="btn btn-danger" />
						</form>
